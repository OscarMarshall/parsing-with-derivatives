...
(t/deftest alternation-pattern-test
  (t/testing "match-one"
    (t/is (= (sut/alternation-pattern (sut/failure-pattern) (sut/failure-pattern))
             (sut/match-one (sut/alternation-pattern (sut/character-pattern \a) (sut/character-pattern \b)) \c))
          "#\"a|b\" << c => #\"<fail>|<fail>\"")
    (t/is (= (sut/alternation-pattern (sut/empty-pattern) (sut/failure-pattern))
             (sut/match-one (sut/alternation-pattern (sut/character-pattern \a) (sut/character-pattern \b)) \a))
          "#\"a|b\" << a => #\"|<fail>\"")
    (t/is (= (sut/alternation-pattern (sut/sequence-pattern (sut/character-pattern \a))
...
(t/deftest sequence-pattern-test
  (t/testing "match-one"
    (t/is (= (sut/sequence-pattern (sut/failure-pattern) (sut/failure-pattern))
             (sut/match-one (sut/sequence-pattern (sut/character-pattern \b) (sut/character-pattern \a)) \a))
          "#\"ba\" << \\a => failure")
    (t/is (= (sut/sequence-pattern (sut/character-pattern \b))
    ...
    (t/is (= (sut/sequence-pattern (sut/character-pattern \a))
          ...
          "#\"aa\" << \\a => #\"a\"")
    (t/is (= (sut/alternation-pattern (sut/failure-pattern) (sut/sequence-pattern (sut/empty-pattern)))
             (sut/match-one (sut/sequence-pattern (sut/alternation-pattern (sut/empty-pattern)
                                                                           (sut/character-pattern \b))
                                                  (sut/character-pattern \a))
                            \a))
          "#\"b?a\" << \\a => #\"\"")
    (t/is (= (sut/alteration-pattern (sut/sequence-pattern (sut/alternation-pattern (sut/failure-pattern)
                                                                                    (sut/empty-pattern))
                                                           (sut/character-pattern \a))
                                     (sut/sequence-pattern (sut/empty-pattern)))
